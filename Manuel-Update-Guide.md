...
cd  
polis-cli stop  
wget https://github.com/polispay/polis/releases/download/v1.6.3/poliscore-1.6.3-x86_64-linux-gnu.tar.gz  
tar -xvf poliscore-1.6.3-x86_64-linux-gnu.tar.gz 
rm poliscore-1.6.3-x86_64-linux-gnu.tar.gz  
rm /usr/local/bin/polis*  
cp poliscore-1.6.3/bin/polis{d,-cli} /usr/local/bin/  
rm -r poliscore-1.6.3  
polisd &  
