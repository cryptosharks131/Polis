...
COIN_REPO='https://github.com/polispay/polis/releases/download/v1.6.2/poliscore-1.6.2-x86_64-linux-gnu.tar.gz'
...
function create_key() {
  echo -e "Generating a new BLS ${RED}Masternode Private Key${NC} for you:"
#   read -e COINKEY
